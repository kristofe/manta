...
class Voxels(object):
    ...
    def __init__(self, data, dims, translate, scale, axis_order, name):
        self.data = data
        self.dims = dims
...
def read_as_3d_array(fp, fix_coords=True):
    ...
    if fix_coords:
        ...
        axis_order = 'xzy'
    return Voxels(data, dims, translate, scale, axis_order, fp)
...
def read_as_coord_array(fp, fix_coords=True):
    ...
    return Voxels(np.ascontiguousarray(data), dims, translate, scale, axis_order, fp)
