...
sphere = s.create(Sphere, center=gs*vec3(0.5,0.6,0.5), radius=res*0.2)
source = s.create(Cylinder, center=gs*vec3(0.5,0.1,0.5), radius=res*0.14, z=gs*vec3(0, 0.02, 0))

flags.initDomain()
flags.fillGrid()

#Add sphere to flags grid... this should cause it to be an obstacle
sphere.applyToGrid(grid=flags, value=0.0) 
